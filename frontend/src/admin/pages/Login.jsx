    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-body-bg text-body-text-color">
      <div className="flex w-[90%] flex-col items-center rounded-xl bg-theme-bg py-8 sm:w-2/5 sm:px-6">
        ...
        <h1 className="text-3xl font-bold text-white">
          ...
          <span className="uppercase text-theme-color">A</span>uction Admin
        </h1>

        <p className="m-2 text-xl">Login to Admin Portal</p>
        ...
        >
          ...
          <div className="overflow-hidden flex justify-between items-center w-full rounded bg-theme-bg2 outline-none mb-4 border border-border-info-color">
            <input
              type="password"
