      ...
      <div className="flex items-center cursor-pointer z-[1]">
        {user ? (
          ...
          <>
            <Link
              to="/login"
              className="bg-theme-color no-underline font-Roboto text-base hover:bg-hover transition-all duration-150 text-white py-1 sm:py-2 sm:px-3 px-2 rounded-md text-md font-semibold"
            >
              Sign In
            </Link>
            <Link
